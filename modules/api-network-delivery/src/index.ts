...
// Register network delivery routes
app.use('/', networkDeliveryRouter);

// Error handler
app.use((err: any, req: express.Request, res: express.Response, next: express.NextFunction) => {
  console.error('❌ [NETWORK DELIVERY API ERROR]', err);
...
// Export the network delivery API function
export const apiNetworkDelivery = onRequest({
  memory: '1GiB',
  timeoutSeconds: 300,
  cpu: 1,
  minInstances: 0,
