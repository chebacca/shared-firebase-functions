/**
 * Shared Webex encryption key secret
 * This secret is defined here and imported by all Webex functions that need encryption
 * Uses the same encryption key as Google for consistency
 */

import { defineSecret } from 'firebase-functions/params';

// Define the encryption key secret once, use it everywhere
// Reuse the same ENCRYPTION_KEY as Google for consistency
