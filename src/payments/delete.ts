...
export const deletePayment = functions.https.onRequest(async (req: any, res: any) => {
  try {
    // Set CORS headers
...
export const deletePaymentCallable = functions.https.onCall(async (data: any, context: any) => {
  return await deletePaymentLogic(data, context);
});
